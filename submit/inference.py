...
def projection(img_path):
    ...
    url = 'https://nvlabs-fi-cdn.nvidia.com/stylegan2-ada-pytorch/pretrained/metrics/vgg16.pt' #'./input/pretrained_models/vgg16.pt'
...
network_pkl = 'https://nvlabs-fi-cdn.nvidia.com/stylegan2-ada-pytorch/pretrained/afhqdog.pkl' #'./input/pretrained_models/afhqdog.pkl'
...
video_mp4 = imageio.get_writer('./output/proj.mp4', mode='I', fps=10, codec='libx264', bitrate='16M')
video_gif = imageio.get_writer('./output/proj.gif', mode='I', fps=10,)
for img in img_list:
    video_mp4.append_data(img)
    video_gif.append_data(img)
video_mp4.close()
video_gif.close()
print (f'Saving optimization progress video "./output/proj.mp4&gif"')
########################################################################################################################
################################################ End #############################################